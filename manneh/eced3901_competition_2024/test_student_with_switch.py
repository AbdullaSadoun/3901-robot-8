...
def main():
	...
	# Initiate serial
	ser = serial.Serial(
			port='/dev/ttyUSB1', # USB number could change depending on what port the USB is plugged into. DOUBLE CHECK THIS
			baudrate=9600)
	...
	example_group_number = 1 if team_number == '1' else 2 
