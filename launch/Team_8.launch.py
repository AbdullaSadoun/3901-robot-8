...
def generate_launch_description():
  ...
  # Launch the competition publisher
  start_competition_publisher =	Node(
			package='eced3901',
			executable='competition_publisher.py',
			name='competition_publisher',
			output='screen'
		)
  
  # Launch the competition subscriber
  start_pose_listener =	Node(
			package='eced3901',
  ...
  start_switch = Node(
			package='eced3901',
			executable='start_with_switch.py',
			name='start_with_switch',
			output='screen'
		)
  ...
  ld.add_action(start_pose_listener)
  ld.add_action(start_competition_publisher)
  ld.add_action(start_switch)  
